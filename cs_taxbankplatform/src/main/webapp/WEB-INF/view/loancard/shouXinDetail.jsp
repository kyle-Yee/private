...
<div>
	<div class="SL1"><span>授信审批单</span></div>
	<div class="SL2">
		<table class="SlTab">
			<tr>
			...
			<tr>
				<td>联系人地址</td>
				<td>${cardDetail.loanCardRecordEntity.xr_lxrdz} </td>
				<td>营销经理推荐代码</td>
			...
			<!-- ============================终审记录Start=========================== -->
			<tr>
				<td colspan="4" class="headTd">授信结果</td>
			</tr>
			<c:choose>
				<%-- 终审通过 --%>
				<c:when test="${cardDetail.loanCardRecordEntity.xr_kpzt eq 1}">
					<tr>
						<td>审核结果</td>
						<td colspan="3">通过</td>
					</tr>
					<tr>
						<td>审批时间</td>
						<td>${cardDetail.loanCardRecordEntity.xr_zs_sxsj}</td>
						<td>授信额度</td>
						<td>${cardDetail.loanCardRecordEntity.xr_sxed}万元</td>
					</tr>
				</c:when>
				<%-- 终审不通过 --%>
				<c:when test="${cardDetail.loanCardRecordEntity.xr_kpzt eq 2}">
					<tr>
						<td>审核结果</td>
						<td colspan="3">不通过</td>
					</tr>
					<tr>
						<td>审批时间</td>
						<td colspan="3">${cardDetail.loanCardRecordEntity.xr_zs_sxsj}</td>
					</tr>
				</c:when>
				<%-- 无记录 --%>
				<c:otherwise>
