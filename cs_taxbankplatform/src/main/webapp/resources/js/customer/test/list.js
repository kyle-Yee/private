...
var dtGridColumns = [{
    ...
    resolution : function(value, record, column, grid, dataNo, columnNo) {
    	...
    	if(record.la_status == "DKZT01"){
    		...
    		return '<span id='+value+' onclick="downloadPdf('+"'"+value+"'"+','+"'"+record.creatorid+"'"+','+"'"+record.la_status+"'"+',&quot;'+record.nsryhxxEntity.qymc+'&quot;)"><img src="resources/images/u1582.png" title ="下载报告"></span>';
    	}
    	//待授信按钮处理
...
//    	}
    	...
    	if(record.la_status == "DKZT04"){
    		flag = 2;
    		return '<span><img src="resources/images/u1608.png" title ="下载报告"></span>';
    	}
    	//未受理按钮处理()
