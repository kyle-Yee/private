...
$(function() {
	if(window.navigator.userAgent.indexOf("Trident") != -1){
		layer.msg('为了功能使用稳定，建议使用360浏览器极速模式',{icon:7});
	    ...
	    $.ajax({
			async:false,
			type : "POST",
			url : sys.rootPath + "/message/getMessageCount.html",
			data : null,
			dataType : "json",
			success : function(resultdata) {
				sysCount = resultdata.sysCount;
				managerCount = resultdata.managerCount;
				otherCount = resultdata.otherCount;
			}
		});
	    var allCount = Number(sysCount)+Number(managerCount)+Number(otherCount);
	    $("#sysCount").html("+"+sysCount);
	    $("#managerCount").html("+"+managerCount);
	    $("#otherCount").html("+"+otherCount);
	    $("#allCount1").html(allCount);
	    $("#allCount2").html(allCount);
	}else{	
		webside.index.initHomePage();
	    webside.index.initMenu();
	    webside.index.initNavigation();
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> 
					<small> 
						<img src="${ctx }/resources/images/taxlog.png" height="30px" width="30px;" />  税银平台管理系统
					</small>
				</a>
			...
			<div class="navbar-buttons navbar-header pull-right" id="message"
				role="navigation">
				<ul class="nav ace-nav">
						<li class="green">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<i class="ace-icon fa fa-bell icon-animated-bell"></i>
								<span class="badge badge-success"><span id="allCount1"></span></span>
							</a>

							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								<li class="dropdown-header">
									<i class="ace-icon fa fa-envelope-o"></i>
									<span id="allCount2"></span>条通知
								</li>
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#">
												<div class="clearfix" onclick="showMessage('XX01')">
													<span class="pull-left">
														<i class="btn btn-xs no-hover btn-pink fa fa-comment"></i>
														系统消息
													</span>
													<span class="pull-right badge badge-info" id="sysCount"></span>
												</div>
											</a>
										</li>
										...
										<li>
											<a href="#">
												<div class="clearfix" onclick="showMessage('XX02')">
													<span class="pull-left">
														<i class="btn btn-xs no-hover btn-success fa fa-shopping-cart"></i>
														管理员消息
													</span>
													<span class="pull-right badge badge-success" id="managerCount"></span>
												</div>
											</a>
										</li>
										...
										<li>
											<a href="#">
												<div class="clearfix" onclick="showMessage('XX03')">
													<span class="pull-left">
														<i class="btn btn-xs no-hover btn-info fa fa-twitter"></i>
														其他消息
													</span>
													<span class="pull-right badge badge-info" id="otherCount"></span>
												</div>
											</a>
										</li>
									</ul>
								...
								<li class="dropdown-footer" onclick="showMessage(0)">
									<a href="#">
										查看所有消息
		...
		<div id="sidebar" class="sidebar responsive">
			...
			<%-- <div class="sidebar-shortcuts" id="sidebar-shortcuts">
				<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
					<button class="btn btn-success" onclick="javascript:window.location.href='${ctx}'">
		...
		<!-- <div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">Tax &nbsp; Bank &nbsp; Platform &nbsp;</span>
						Application &copy; 张孟志  &nbsp; &nbsp; 2016
