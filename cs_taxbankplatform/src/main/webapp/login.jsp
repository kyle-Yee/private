...
<link rel="stylesheet" href="${ctx}/resources/css/customer/login/style.css"/>
...
function wjmm(){
    layer.open({
        ...
        id: "LAY_demo auto", //防止重复弹出
        content: "<div style='padding: 20px 80px;'>请联系系统管理员进行密码重置。</div>",
        btn: "知道了",
        btnAlign: "c", //按钮居中
        shade: 0, //不显示遮罩
        yes: function(){
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<%-- <div class="center">
							<h1>
								<img src="${ctx }/resources/images/webside.ico"/>
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div> -->
										<div class="header">
											<div class="top1">税银服务平台后台管理系统</div>
											<div class="top2">用户登录</div>
										</div>
										...
										<form id="loginform" name="loginform"
											...
											<fieldset>
												...
												<span class="block input-icon input-icon-left"> 
													...
													<span class="faUser"></span>
													<input name="accountName" id="accountName" type="email" class="form-control" placeholder="请输入邮箱账号" value="${accountName }"/> 
												</span>
												</label>
												<label class="block clearfix"> 
												<span class="block input-icon input-icon-left"> 
													<!-- <i class="ace-icon fa fa-lock"></i> -->
													<span class="faLock"></span>
													<input name="password" id="password" type="password" class="form-control" placeholder="请输入密码" value="${password }"/>
												</span>
												</label>
 												<label class="block clearfix">
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="registerform" name="registerform" action="${ctx }/register.html"
											...
											<fieldset>
												<c:if test="${!empty regionsList}">
													<label for="region" class="block clearfix"> 
														<span>
															<select name="regionid" id="regionid" class="form-control">
																<c:forEach items="${regionsList}" var="item">
