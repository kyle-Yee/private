...
public class EndecryptUtils {
    ...
    public static String encrytPassword(String username, String password, String salt, int hashIterations) {
        String cipherpassword = new Md5Hash(password, username + salt, hashIterations).toBase64();
    ...
    public static void main(String[] args) { //vBAz3kfHBOz9i+hW7YG9RQ==#####456d71fecf4743323af52653115b7076
    	UserEntity md5Password = md5Password("dlnsh@tbp.com", "123456", 2);
    	System.out.println(md5Password.getPassword() + "#####" + md5Password.getCredentialsSalt());
