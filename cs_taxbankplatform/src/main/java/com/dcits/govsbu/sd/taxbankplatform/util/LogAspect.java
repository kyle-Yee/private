...
public class LogAspect {
	 ...
	 */
	@Pointcut("execution(* com.dcits.govsbu.sd.taxbankplatform.*.controller.*.add(..))")
	 ...
	 */
	@Pointcut("execution(* com.dcits.govsbu.sd.taxbankplatform.*.controller.*.update(..)) "
			+ "|| execution(* com.dcits.govsbu.sd.taxbankplatform.*.controller.*.resetPassword(..)) "
			+ "|| execution(* com.dcits.govsbu.sd.taxbankplatform.*.controller.*.info(..)) "
			+ "|| execution(* com.dcits.govsbu.sd.taxbankplatform.*.controller.*.password(..))")
	 ...
	 */
	@Pointcut("execution(* com.dcits.govsbu.sd.taxbankplatform.*.controller.*.delete*(..))")
	 ...
	 * 删除业务逻辑方法切入点 定义在controller包里以delete为前缀的方法的执行
	 */
	@Pointcut("execution(* com.dcits.govsbu.sd.taxbankplatform.*.controller.*.permission(..))")
	...
	public void insertServiceCallCalls(JoinPoint joinPoint, Object rtv)
			throws Throwable {
		// 获取登录管理员id
		String adminUserId = Common.getloginUserId();
		...
		log.setId(IDGenerate.getZJID("RIZ"));
		log.setUserId(String.valueOf(adminUserId));// 设置管理员id
	...
	public void deleteServiceCallCalls(JoinPoint joinPoint, Object rtv)
		...
		LogInfoEntity log = new LogInfoEntity();
		log.setId(IDGenerate.getZJID("RIZ"));
		log.setUserId(String.valueOf(Common.getloginUserId()));// 用户编号
		log.setAccountName(Common.getloginUserAccountName());
		log.setCreateTime(new Date());// 操作时间
