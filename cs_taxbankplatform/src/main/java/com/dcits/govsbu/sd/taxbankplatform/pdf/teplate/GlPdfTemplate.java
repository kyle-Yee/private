 ...
 * <p>Description: </p>
 * <p>versions:1.0 
 * <p>file name：GlPdfTemplate.java
 * <p>Company:dfwyBank</p>
 * <p>@author: Zhongyj 
 * <p>Created: 2017-8-25下午下午3:33:022:57:43 
 * <p>department:深圳IT部门  
...
/**
 * @versions:1.0 
 * @filename：GlPdfTemplate.java
 * @Company:dfwyBank
 * @Created: 2017-8-25下午下午3:33:022:57:43 
 * @department:深圳IT部门  
 * @Copyright Copyright (c) dfwy. All rights reserved.
 * @author Zhongyj
 * @ClassName GlPdfTemplate
 */
import java.io.File;
...
public class GlPdfTemplate {
	...
	public static void addMark(PdfStamper pdfStamper,int pageSize) throws DocumentException, IOException{
         ...
         String waterMarkName="桂林税银互动服务平台";       
    ...
    public void generatePDF(File file, String id) throws Exception {   
    		...
    		String str = nsrmc +"因申请办理"+orgName+"小微企业"+fpName+"授信业务的需要"+
    				"，特授权广西壮族自治区国家税务局通过税银互动服务平台向"+orgName+"提供涉税数据。";
    		...
    		str = "上述数据为广西壮族自治区国家税务局按规定原则提供的自身采集的原始数据，仅用于银税服务的参考。";
    		d.addCell(createCell(str, textfont,Element.ALIGN_LEFT,1));
    		d.addCell(createCell("广西壮族自治区国家税务局", textfont,1));
    		e.addCell(d);
    		document.add(e);
    		document.close();
    	}
