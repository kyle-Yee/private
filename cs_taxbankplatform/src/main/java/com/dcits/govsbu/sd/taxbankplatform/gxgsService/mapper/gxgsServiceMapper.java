 ...
 * @author: 方认
 * @version V1.0 
 * @date: 2018年2月7日 下午5:38:44
 * @copyright©2018东方微银网络信息（北京）有限公司 
 * @fileName:com.dcits.govsbu.sd.taxbankplatform.gxgsService.mapper.gxgsServiceMapper.java
 */
@Repository
public interface gxgsServiceMapper  extends BaseMapper<Map<String, Object>, Object>{
	...
	/* //更新授权结果 
	 ...
	 //新增sypt_bank_apply用户认证记录表
	 public int insertSyptBankApply(Map<String,Object> map);
	 //更新授权记录表
