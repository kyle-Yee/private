...
public class Common {
	 ...
	 * @return
	 */
	public static String getloginUserOrgotid()
	{
		Subject subject = SecurityUtils.getSubject();
		UserEntity sessionUser = (UserEntity)subject.getSession().getAttribute("userSession");
		return sessionUser.getOrganizationEntity().getOtid();
	}
	 ...
	 * @return
	 */
	public static String getloginUserRegionid()
	{
		Subject subject = SecurityUtils.getSubject();
		UserEntity sessionUser = (UserEntity)subject.getSession().getAttribute("userSession");
		return sessionUser.getRegionid();
	}
