package com.dcits.govsbu.sd.taxbankplatform.shiro;
...
/**
 * 
 * LimitRetryHashedMatcher.java
 * @author 张孟志
 * @date 2016年7月1日
 * @caption 限制登录次数，如果连续5次输错用户名或密码，锁定10分钟，依靠Ehcache自带的timeToIdleSeconds来保证锁定时间
 */
