			...
			<div id="formDiv" style="display: none;">
			   ...
			   <div class="form-group">
			      ...
			      <div class="col-sm-10">
			           <div class="radio">
							<label>
								<input name="userInfo.sex" type="radio"  value="1" <c:if test="${userEntity.userInfo.sex eq 1}">checked</c:if>>
								<span class="lbl bigger-110">男</span>
							</label>
							<label>
								<input name="userInfo.sex" type="radio"  value="2" <c:if test="${userEntity.userInfo.sex eq 2}">checked</c:if>>
