...
<script type="text/javascript" src="${ctx }/resources/js/customer/financialProduct/form.js"></script>	
...
.viewLoanForms #loanFormsForm .row input[name="rwId"]{
	margin-right:6px;
}
	...
	<div class="col-xs-12">
		<form id="financialProductForm" name="financialProductForm" class="form-horizontal" role="form" method="post">
			...
			<div class="form-group row">
				...
				<label class="control-label col-sm-1 no-padding-right" for="fpName"><span class="text-danger">*</span>产品编号</label>
				<div class="clearfix col-md-4">
					<input class="form-control" id="id" name="id" type="text" <c:if test="${!empty financialProduct.id}">readonly="readonly"</c:if> value="${financialProduct.id }"
						placeholder="理财产品编号..." />
				</div>
			</div>
			<div class="form-group row">
...
<div id="loanForms" style=" display:none; width: 100%;">
	...
	<div class="viewLoanForms">
		...
		<form id="loanFormsForm" name="loanFormsForm" onsubmit="return false;" method="post">
			<div class="row">
				<label class="control-label col-sm-1 no-padding-right" id="dked_label" for="lf_dked"><span class="text-danger">*</span>贷款额度</label>
				<div class="col-md-4">
					<input readOnly="true" disabled="true" class="form-control" id="lf_dked" name="1" type="text"/>
				</div>
			</div>
			<div class="row">
				<label class="control-label col-sm-1 no-padding-right" id="dkqx_label" for="lf_dkqx"><span class="text-danger">*</span>贷款期限</label>
				<div class="col-md-4">
					<input readOnly="true" disabled="true" class="form-control" id="lf_dkqx" name="2" type="text" />
				</div>
			</div>
			<div class="row" id="afterFlag">
				<label class="control-label col-sm-1 no-padding-right" id="hkfs_label" for="lf_hkfs"><span class="text-danger">*</span>还款方式</label>
				<div class="col-sm-7" id="lf_hkfs"></div>
			</div>
	...
	<div class="center">
			...
			<c:if test="${!empty financialProduct}">
				<button  onclick="webside.common.loadPage('/financialProduct/editUI.html?ptdm=1&id=${financialProduct.id }')">上一步</button>
			</c:if>
			<c:if test="${empty financialProduct}">
				<!-- <button  onclick="webside.common.loadPage('/financialProduct/addUI.html?ptdm=1')">上一步</button> -->
